...
<body>
	<h2>Glazing Assessment Table</h2>
	<p>
		<!-- <a href="foundation_form.php">Add New Data</a> -->
        <a href="glazing_form.php"><button type="button" class="btn btn-danger">Add New Data</button></a>
	</p>
	<p>
		<!-- <a href="foundation_form.php">Add New Data</a> -->
	...
	<table width='100%' border=0 class="table table-striped">
		<tr bgcolor='#DDDDDD'>
			...
			<td><strong>What is the glazing type?</strong></td>
		...
		while ($res = mysqli_fetch_assoc($result)) {
			...
			echo "<td><a href=\"edit_glazing.php?id=$res[id]\" class=\"btn btn-primary\">Edit</a></td>";
		}
		?>
	</table>
</body>
