...
$result = mysqli_query($conn, "SELECT * FROM glazing WHERE id = $id");
...
$glazing_type = $resultData['glazing_type'];
...
<meta charset="UTF-8">
    ...
    <title>Glazing Assessment Form</title>
...
<h1 style="background-color: white; text-align:center;color:black;">Glazing Assessment</h1>
<hr>
    <form name="edit" method="post" action="editAction_glazing.php">
  <div class="row mb-3">
 ...
 <h4 style="color: black; font:bold;">Damages</h4>
  ...
  <div class="row mb-3">
    <label for="Agency" class="col-sm-2 col-form-label">What is the glazing type? </label>
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" name="glazing_type" value="<?php echo $glazing_type; ?>" disabled>
    </div>
  </div>
