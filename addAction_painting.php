...
if (isset($_POST['submit'])) {
	...
	if (empty($reference) || empty($agency) || empty($paint_peeling) || empty($damage_cause_paint) || empty($litres)  || empty($additional_notes)) {
		...
		$result = mysqli_query($conn, "INSERT INTO painting (`reference`, `agency`, `paint_peeling`, `damage_cause_paint`, `litres`, `additional_notes`) VALUES ('$reference', '$agency', '$paint_peeling', '$damage_cause_paint' , '$litres' , '$additional_notes')");
