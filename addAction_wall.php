...
if (isset($_POST['submit'])) {
    ...
    || empty($wall_partitioned_erecting) || empty($wall_replace_wall_repair) || empty($add_note)) {
		...
		$result = mysqli_query($conn, "INSERT INTO wall (`reference`, `agency`, `length`, `width`, `height`, `walls_damp` , `peeling_paint` , `walls_cracked` , `boundary_wall` , `palisade_fence`, `wall_partitioned_erecting`, `wall_replace_wall_repair` , `add_note`) VALUES ('$reference', '$agency', '$length', '$width' , '$height' , '$walls_damp', '$peeling_paint', '$walls_cracked', '$boundary_wall', '$palisade_fence', '$wall_partitioned_erecting', '$wall_replace_wall_repair', '$add_note')");
		
		// Display success message
		echo "<p><font color='green'>Data added successfully!</p>";
		echo "<a href='wall_table.php'>View Result</a>";
	}
}
?>
</body>
