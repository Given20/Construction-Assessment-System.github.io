...
<hr>
    <h4 style="color: black; font:bold;">Glazing</h4>
    <form action="addAction_glazing.php" method="post" name="add">
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" name="glazing_type">
    </div>
  </div>
