...
<hr>
    ...
    <form action="addAction_cardboard.php" method="post" name="add">
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" name="cardboard_type">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" name="cardboard_replacement">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="damage" name="cardboard_notes">
    </div>
  </div>
