...
<hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="ceiling_intact"value="<?php echo $ceiling_intact; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="ceiling_type"value="<?php echo $ceiling_type; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="water_damage"value="<?php echo $water_damage; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="spots_stains_mold"value="<?php echo $spots_stains_mold; ?>">
    </div>
  </div>
  ...
  <div class="col-sm-9">
    <input type="text" class="form-control" id="damage" name="ceiling_note" value="<?php echo $ceiling_note; ?>">
  </div>
</div>
