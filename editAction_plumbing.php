...
if (isset($_POST['update'])) {
  ...
  $result = mysqli_query($conn, "UPDATE plumbing SET `reference` = '$reference', `agency` = '$agency', `geyser_condition` = '$geyser_condition', `vacuum_breakers` = '$vacuum_breakers', `drip_tray` = '$drip_tray' , `pressure_control` = '$pressure_control' , `tile_damage` = '$tile_damage', `pipe_leaking` = '$pipe_leaking', `check_pipe_fittings` = '$check_pipe_fittings', `conduct` = '$conduct', `leaking_taps` = '$leaking_taps', `waste_pipes` = '$waste_pipes',  `drain_blockage` = '$drain_blockage', `bathroom_leaking_taps` = '$bathroom_leaking_taps', `leaking_blocked_pipes` = '$leaking_blocked_pipes', `waste_pipe_condition` = '$waste_pipe_condition', `water_closet` = '$water_closet', `rubber_intact` = '$rubber_intact', `water_intake_block` 
  = '$water_intake_block', `flexible_pipe` = '$flexible_pipe', `shower_issues` = '$shower_issues', `shower_condition` = '$shower_condition', `shower_tap` = '$shower_tap', `notes` = '$notes' WHERE `id` = $id");
