...
<body>
	<h2>Painting Assessment Table</h2>
	<p>
		<!-- <a href="foundation_form.php">Add New Data</a> -->
        <a href="paint_form.php"><button type="button" class="btn btn-danger">Add New Data</button></a>
	</p>
	<p>
		<!-- <a href="foundation_form.php">Add New Data</a> -->
	...
	<table width='100%' border=0 class="table table-striped">
		<tr bgcolor='#DDDDDD'>
			...
			<td><strong>Is the paint peeling off?</strong></td>
			<td><strong>What is the cause of the damage?</strong></td>
			<td><strong>How many of litres of paint do you need?</strong></td>
		...
		while ($res = mysqli_fetch_assoc($result)) {
			...
			echo "<td><a href=\"edit_painting.php?id=$res[id]\" class=\"btn btn-primary\">Edit</a></td>";
		}
		?>
	</table>
</body>
