...
<h2>Wall Table</h2>
    <table width='100%' border=0 class="table table-striped">
        <tr bgcolor='#DDDDDD'>
            ...
            <td><strong>Is Paint Peeling</strong></td>
            <td><strong>Are Walls Cracked</strong></td>
        ...
        while ($res = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>
                <a href=\"view_wall.php?id=$res[id]\" class=\"btn btn-primary\">View</a> | 
                <a href=\"delete_wall.php?id=$res[id]\" class=\"btn btn-danger\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>
            </td>";
        }
        ?>
    </table>
