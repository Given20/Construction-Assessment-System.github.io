...
<hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="surface_uneven" placeholder="Yes Or No"value="<?php echo $surface_uneven; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="damage_water" placeholder="Yes Or No" value="<?php echo $damage_water; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="tiles_replace" placeholder="Yes Or No" value="<?php echo $tiles_replace; ?>">
    </div>
  </div>
...
<p>Accurately verify the measurements?</p>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" name="add_notes" class="form-control" id="inputEmail3"value="<?php echo $add_notes; ?>">
    </div>
  </div>
