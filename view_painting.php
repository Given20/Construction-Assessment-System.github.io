...
<hr>
 ...
 <hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="Agency" name="paint_peeling"value="<?php echo $paint_peeling; ?>" disabled>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="Agency" name="damage_cause_paint"value="<?php echo $damage_cause_paint; ?>" disabled>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="Agency" name="litres"value="<?php echo $litres; ?>" disabled>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="Agency" name="additional_notes"value="<?php echo $additional_notes; ?>" disabled>
    </div>
  </div>
