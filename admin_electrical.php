...
<h2>Electrical Table</h2>
    <table width='100%' border=0 class="table table-striped">
        ...
        while ($res = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>
                <a href=\"view_electrical.php?id=$res[id]\" class=\"btn btn-primary\">View</a>
                <a href=\"delete_electrical.php?id=$res[id]\" class=\"btn btn-danger\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>
            </td>";
        }
        ?>
    </table>
