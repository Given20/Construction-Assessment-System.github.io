...
if (isset($_POST['submit'])) {
    ...
    || empty($zinc_roof) || empty($loose_nails) || empty($tiles_aligned) || empty($trusses) || empty($valley_point) || empty($valley_point_leaking) || empty($condition_valley_point) || empty($gutter_condition) || empty($additional_notes)) {
		...
		$result = mysqli_query($conn, "INSERT INTO roofing (`reference`, `agency`, `roof_type`, `roof_cracked`, `roof_leaking`, `cause_of_leaking` , `broken_tiles`, `length`, `width`, `height`, `number_of_tiles_broken`, `zinc_roof`, `loose_nails`, `tiles_aligned`, `trusses`, `valley_point`, `valley_point_leaking`, `condition_valley_point`, `gutter_condition`, `additional_notes`) 
        VALUES ('$reference', '$agency', '$roof_type', '$roof_cracked' , '$roof_leaking' , '$cause_of_leaking', '$broken_tiles', '$length', '$width', '$height', '$number_of_tiles_broken', '$zinc_roof', '$loose_nails', '$tiles_aligned', '$trusses', '$valley_point', '$valley_point_leaking', '$condition_valley_point', '$gutter_condition', '$additional_notes')");
