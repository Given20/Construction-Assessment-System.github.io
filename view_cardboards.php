...
<hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="damage" name="cardboard_type"value="<?php echo $cardboard_type; ?>" disabled>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="damage" name="cardboard_replacement"value="<?php echo $cardboard_replacement; ?>" disabled>
    </div>
  </div>
  ...
  <div class="col-sm-9">
    <input type="text" class="form-control" id="damage" name="cardboard_notes" value="<?php echo $cardboard_notes; ?>" disabled>
  </div>
</div>
