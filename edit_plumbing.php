...
<hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" name="reference" class="form-control" id="inputEmail3" value="<?php echo $reference; ?>">
    </div>
  </div>
 ...
 <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="geyser_condition" value="<?php echo $geyser_condition; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="vacuum_breakers" value="<?php echo $vacuum_breakers; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="drip_tray" value="<?php echo $drip_tray; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="pressure_control" value="<?php echo $pressure_control; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="tile_damage" value="<?php echo $tile_damage; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="pipe_leaking" value="<?php echo $pipe_leaking; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="check_pipe_fittings" value="<?php echo $check_pipe_fittings; ?>">
    </div>
  </div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="conduct" value="<?php echo $conduct; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="leaking_taps" value="<?php echo $leaking_taps; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="waste_pipes" value="<?php echo $waste_pipes; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="drain_blockage" value="<?php echo $drain_blockage; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Are there any leaking taps?</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="bathroom_leaking_taps" value="<?php echo $bathroom_leaking_taps; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="leaking_blocked_pipes" value="<?php echo $leaking_blocked_pipes; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="waste_pipe_condition" value="<?php echo $waste_pipe_condition; ?>">
    </div>
  </div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="water_closet" value="<?php echo $water_closet; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="rubber_intact" value="<?php echo $rubber_intact; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="water_intake_block" value="<?php echo $water_intake_block; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="flexible_pipe" value="<?php echo $flexible_pipe; ?>">
    </div>
  </div>
...
<hr>
  ...
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Are there any leaking or blocked pipes?</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="shower_issues" placeholder="Yes Or No" value="<?php echo $shower_issues; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">What is the condition of the waste pipe?</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="shower_condition" placeholder="Yes Or No" value="<?php echo $shower_condition; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="shower_tap" value="<?php echo $shower_tap; ?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="notes" value="<?php echo $notes; ?>">
    </div>
  </div>
