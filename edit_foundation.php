...
<hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" placeholder="Yes Or No" name="damages"value="<?php echo $damages; ?>">
    </div>
  </div>
  ...
  <hr>
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" placeholder="Yes Or No" name="cracks" value="<?php echo $cracks; ?>">
    </div>
  </div>
