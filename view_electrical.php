...
<hr>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" placeholder="Yes Or No" name="damage_cause"value="<?php echo $damage_cause; ?>" disabled>
    </div>
  </div>
  ...
  <hr>
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="damage" placeholder="Yes Or No" name="replacement" value="<?php echo $replacement; ?>" disabled>
    </div>
  </div>
