...
<a href="todo_table.php"><button type="button" class="btn btn-success">Tasks To Complete</button></a>
    ...
    <div class="container py-3">
            <div class="row">
                <div class="col-md-4">
                <a href = "foundation_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                           <h5 class="card-title"><b>Foundation</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="foundation_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                ...
                <div class="col-md-4">
                <a href = "tiles_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Tiles</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="tiles_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                <a href = "paving_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Paving</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="paving_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                <a href = "electrical_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Electrical</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="electrical_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                <a href = "plumbing_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Plumbing</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="plumbing_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                <a href = "paint_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Paint</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="paint_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="container py-3">
            <div class="row">
                <div class="col-md-4">
                <a href = "ceiling_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Ceiling and Cornice</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="ceiling_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                <a href = "roofing_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Roofing</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="roofing_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                <a href = "wall_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Walls</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="wall_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                <a href = "cardboards_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Cardboards</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="cardboards_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                <a href = "glazing_table.php" style = "text-decoration:none; color:black;" >
                    <div class="card text-black bg-warning mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><b>Glazing</b></h5>
                            <p class="card-text">Please click or select the box to be able to fill in the form!</p>
                            <a href="glazing_table.php" class="btn btn-primary">Select</a>
                        </div>
                        </a>
                    </div>
                </div>   
