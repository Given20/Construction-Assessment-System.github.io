...
<hr>
    <form action="addAction_paving.php" method="post" name="add">
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="broken_tiles_paving">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="surface_uneven_paving">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="damage_water_paving">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="tiles_replace_paving">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" id="inputEmail3" name="tile_damage_paving">
    </div>
  </div>
...
<p>Accurately verify the measurements?</p>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-7">
      <input type="text" name="add_notes_paving" class="form-control" id="inputEmail3">
    </div>
  </div>
